...
<div className='flex items-center space-x-4'>
    ...
    className="relative hover:text-black"><HiOutlineShoppingBag className='h-6 w-6 text-gray-700' />
...
transition-transform  duration-300 z-5 ${ navDrawerOpen ? "translate-x-0" : "-translate-x-full"}`}>
